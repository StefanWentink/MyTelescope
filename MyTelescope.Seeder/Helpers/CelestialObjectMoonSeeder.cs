namespace MyTelescope.Seeder.Helpers
{
    ...
    public class CelestialObjectMoonSeeder : BaseSeeder<CelestialObject, string>
    {
        ...
        public CelestialObjectMoonSeeder(
            ...
            List<CelestialObjectType> celestialObjectTypes,
        ...
        private static List<CelestialObject> List => new List<CelestialObject>
            {
                new CelestialObject(
                    Celestial.Moon.ToConstant(),
                ...
                new CelestialObject(
                    Celestial.Enceladus.ToConstant(),
                    CelestialObjectTypeDictionary[CelestialObjectTypeConstants.MajorMoon],
                    "#EAE3EB",
